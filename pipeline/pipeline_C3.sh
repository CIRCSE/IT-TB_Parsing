...
python $BINDIR/tree_combiner_no_weigth.py $TEMP/$1-desr-dx-mlp.conll $TEMP/$1-desr-sx-mlp.conll $TEMP/$1-trans.conll $TEMP/$1-mateanna.conll > $OCONLL/$1-combined-C3.conll

python $BINDIR/conllx_evaluator.py $OCONLL/$1-combined-C3.conll $TEST.conll

if [ $CONVERSION = true ]
then
  perl $BINDIR/conll2csts.pl $OCONLL/$1-combined-C3.conll $ICSTS/$1.csts $OCSTS/$1-combined-C3.csts
fi
